...
def test_governed_decision_loop_is_end_to_end_and_deterministic():
    ...
    assert command.to_mapping() == {"contract_version":"S346.1","command_id":"cmd-371-001","command_type":"replenishment","context_id":"ctx-371","proposal":{"action":"replenish","quantity":10},"actor_id":"planner-1","authority":"supply-chain-manager","authorized_at":"2026-08-17T21:00:00Z","evidence_ids":["e-stock-1"],"provenance_ids":["p-erp-1"]}
