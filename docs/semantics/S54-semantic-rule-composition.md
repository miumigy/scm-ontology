...
S54 defines how multiple semantic inference steps can compose into a derivation without making recursive closure, an inference engine, or an LLM part of the Canonical Semantic Model.
