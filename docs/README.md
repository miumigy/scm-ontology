...
46. [`milestones/`](milestones/) — milestone definitions and acceptance reports
47. [`architecture/`](architecture/) — architecture freezes and governance contracts
48. [`archive/`](archive/) — historical documentation no longer part of the active documentation surface
49. [`../AGENTS.md`](../AGENTS.md) — development/agent contract
