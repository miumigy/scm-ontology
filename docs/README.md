...
47. [`milestones/`](milestones/) — milestone definitions and acceptance reports
48. [`architecture/`](architecture/) — architecture freezes and governance contracts
49. [`archive/`](archive/) — historical documentation no longer part of the active documentation surface
50. [`../AGENTS.md`](../AGENTS.md) — development/agent contract
