...
48. [`milestones/`](milestones/) — milestone definitions and acceptance reports
49. [`architecture/`](architecture/) — architecture freezes and governance contracts
50. [`archive/`](archive/) — historical documentation no longer part of the active documentation surface
51. [`../AGENTS.md`](../AGENTS.md) — development/agent contract
