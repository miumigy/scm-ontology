...
49. [`milestones/`](milestones/) — milestone definitions and acceptance reports
50. [`architecture/`](architecture/) — architecture freezes and governance contracts
51. [`archive/`](archive/) — historical documentation no longer part of the active documentation surface
52. [`../AGENTS.md`](../AGENTS.md) — development/agent contract
