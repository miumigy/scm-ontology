...
45. [`milestones/`](milestones/) — milestone definitions and acceptance reports
46. [`architecture/`](architecture/) — architecture freezes and governance contracts
47. [`archive/`](archive/) — historical documentation no longer part of the active documentation surface
48. [`../AGENTS.md`](../AGENTS.md) — development/agent contract
