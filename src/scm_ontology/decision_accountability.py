...
from .snapshot_causal_query import SnapshotCausalChainNotFound, trace_snapshot_causal_chain
...
def trace_decision_accountability(transitions: tuple[SnapshotTransition, ...], decisions: tuple[DecisionTrace, ...], *, snapshot_id: str) -> DecisionAccountability:
    ...
    except SnapshotCausalChainNotFound as exc:
        raise DecisionAccountabilityNotFound(snapshot_id) from exc
