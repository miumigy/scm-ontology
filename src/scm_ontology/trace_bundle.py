...
def build_trace_bundle(
    ...
    """Package the lifecycle references without mutating any source object."""
...
def trace_bundle_to_mapping(bundle: TraceBundle) -> dict[str, Any]:
    return {
        "decision_trace": decision_trace_to_mapping(bundle.decision_trace),
        "execution_request": execution_request_to_mapping(bundle.execution_request),
        "execution_event": execution_event_to_mapping(bundle.execution_event),
        "reasoning_provenance": reasoning_provenance_to_mapping(bundle.reasoning_provenance),
        "validation": trace_validation_to_mapping(bundle.validation),
    }
