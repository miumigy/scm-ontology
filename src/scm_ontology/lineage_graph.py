...
def build_lineage_graph(lineage: CanonicalEventLineage) -> CanonicalGraph:
    """Project immutable event lineage into a deterministic canonical graph."""
        ...
        relationships.append(
            CanonicalRelationship(
                RelationshipInstance(
                    relationship_id=_relationship_id("evidence_for", evidence_id, lineage.event_id),
                    from_id=evidence_id,
    ...
    for provenance_id in lineage.provenance_ids:
        ...
        relationships.append(
            CanonicalRelationship(
                RelationshipInstance(
                    relationship_id=_relationship_id("provenance_for", provenance_id, lineage.event_id),
