...
class DecisionProposal:
    ...
    def to_mapping(self) -> dict[str, Any]:
        return {"decision_id": self.decision_id, "decision_type": self.decision_type, "context_id": self.context_id, "action": self.action, "rationale": self.rationale, "evidence_ids": list(self.evidence_ids), "provenance_ids": list(self.provenance_ids)}
