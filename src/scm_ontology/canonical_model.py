...
CANONICAL_RELATIONSHIPS: tuple[RelationshipSignature, ...] = (
    ...
    RelationshipSignature("observed_at", "Observation", "Entity", RelationshipCategory.EPISTEMIC),
    RelationshipSignature("measured_by", "MetricValue", "Measurement", RelationshipCategory.MEASUREMENT),
    RelationshipSignature("derived_from", "Entity", "Entity", RelationshipCategory.DERIVATION),
    RelationshipSignature("evaluated_by", "Entity", "MetricDefinition", RelationshipCategory.EVALUATION),
